...
class TasksActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Using the professional ViewHolder pattern via TaskAdapter
    ...
    /**
     * Fetches tasks from SQLite and applies UI filters
     */
    private fun loadTasks() {
        ...
        var allTasks = db.getTasksByUserId(currentUserId)
    ...
    /**
     * Logic to toggle task completion and calculate delay
     */
        ...
        if (newStatus == "completed") {
            ...
            try {
                ...
                if (scheduledDate != null && actualDate != null) {
                    // Delay = Actual - (Scheduled + Duration)
    ...
    /**
     * Premium themed delete confirmation
     */
